...
-   Gráfico de barra de la media de puntuaciones por película: Investigar la media de calificaciones (media_review_rate) de las reseñas  por película(film_name) para identificar cuáles son las películas mejor y peor valoradas. Este análisis nos permitirá ver de forma descendente la media de las películas de la puntuación de todo los usuarios, viendo así qué peliculas han sido las más atractivas para el público y cuales menos.
...
Por otro lado, el gráfico de barras de la media de puntuaciones por película, nos ayudará a identificar de manera clara cuáles son las películas mejor y peor valoradas por los usuarios, determinando así cuáles han recibido las calificaciones más altas y cuáles las más bajas. Dicho análisis permitirá visualizar la distribución de las calificaciones medias y detectar tendencias generales en las preferencias del público.Esto podrá contribuir al conocimiento existente sobre el comportamiento de los usuarios en la industria cinematográfica española.
